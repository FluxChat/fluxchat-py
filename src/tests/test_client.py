...
class ClientTestCase(TestCase):
	...
	def test_from_list(self):
		...
		self.assertEqual(client.pubid, 'FC_test1')
	...
	def test_set_pubid(self):
		client = Client()
		client.set_pubid('FC_test1')
	...
	def test_eq1(self):
		client1 = Client()
		client1.set_pubid('FC_test1')
		client2 = Client()
		client2.set_pubid('FC_test1')
